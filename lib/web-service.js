...
webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.authenticate = function(args, callback) {
    ...
    if (args.strUserName.trim() === username && args.strPassword.trim() === password) { 
        //TODO FOR RYAN: replace this if statement condition with a query to the database for a matching username and password. 
        ...
        //otherwise, pull from the database the corresponding xmls (should be stored in the database as a bunch of strings), and put them in localstorage as well
